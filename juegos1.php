...
<body>
  <div class="container">   
    <div class="card-columns mt-3">
      ...
      <img class="card-img-top" src="./img/abeja.jpg" alt="Card image cap">
        <div class="card-body">
    ...
    <!-- Card instrucciones -->
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/letraa.jpg" alt="Card image cap">
        <div class="card-body">
        <!-- <button type="button" class="btn btn-primary" value="" id="verificar"  onclick="indicarSorpresa()">Verificar</button> -->
        </div>
      </div>                  
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/mesa.jpg" alt="Card image cap">
        <div class="card-body">
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/arbol.jpg" alt="Card image cap">
        <div class="card-body">
  ...
  <video id="repa" width="0" height="0"><source src="img/abeja.ogg"></video>
  <video id="repb" width="0" height="0"><source src="img/casa.ogg"></video>
  <video id="repc" width="0" height="0"><source src="img/mesa.ogg"></video>
  <video id="repd" width="0" height="0"><source src="img/arbol.ogg"></video>
</body>
</html>
<script>
// Sorpresa y fallo
