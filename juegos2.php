...
<body>
  <div class="container">   
    <div class="card-columns mt-3">
      ...
      <img class="card-img-top" src="./img/reloj.jpg" alt="Card image cap">  <!--Referencia de la imagen-->
        <div class="card-body">
    ...
    <!-- Card 2 -->
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/elefante.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
    ...
    <!-- Card instrucciones -->
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/e.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
        <!-- <button type="button" class="btn btn-primary" value="" id="verificar"  onclick="indicarSorpresa()">Verificar</button> -->
        </div>
      </div>                  
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/escalera.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/helado.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
  ...
  <video id="repa" width="0" height="0"><source src="img/reloj.ogg"></video> <!--Referencia del audio-->
  <video id="repb" width="0" height="0"><source src="img/elefante.ogg"></video><!--Referencia de la audio-->
  <video id="repc" width="0" height="0"><source src="img/escalera.ogg"></video><!--Referencia de la audio-->
  <video id="repd" width="0" height="0"><source src="img/helado.ogg"></video><!--Referencia de la audio-->
</body>
</html>
<script>
// Sorpresa y fallo
