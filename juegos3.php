...
<body>
  <div class="container">   
    <div class="card-columns mt-3">
      ...
      <img class="card-img-top" src="./img/guitarra.jpg" alt="Card image cap">  <!--Referencia de la imagen-->
        <div class="card-body">
    ...
    <!-- Card 2 -->
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/vaca.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
        <a href="#" id="b" class="btn btn-primary" onclick="indicarFallo();iniciarCasa();">Verificar</a>
        </div>
      </div>  
    <!-- Card instrucciones -->
      <div class="card text-center border-info">
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/g.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
        <!-- <button type="button" class="btn btn-primary" value="" id="verificar"  onclick="indicarSorpresa()">Verificar</button> -->
        </div>
      </div>                  
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/balon.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
        <a href="#" id="c" class="btn btn-primary" onclick="indicarFallo();iniciarMesa();">Verificar</a>
        </div>
      </div>          
  
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/gatoAmarillo.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
        <a href="#" id="d" class="btn btn-primary" onclick="indicarSorpresa();iniciarArbol();">Verificar</a>
        </div>
      </div>     
    </div>
  </div>  
  <video id="repa" width="0" height="0"><source src="img/guitarra.ogg"></video> <!--Referencia del audio-->
  <video id="repb" width="0" height="0"><source src="img/vaca.ogg"></video><!--Referencia de la audio-->
  <video id="repc" width="0" height="0"><source src="img/balon.ogg"></video><!--Referencia de la audio-->
  <video id="repd" width="0" height="0"><source src="img/gato.ogg"></video><!--Referencia de la audio-->
</body>
</html>
<script>
// Sorpresa y fallo
