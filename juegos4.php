...
<body>
  <div class="container">   
    <div class="card-columns mt-3">
      ...
      <img class="card-img-top" src="./img/koala.jpg" alt="Card image cap">  <!--Referencia de la imagen-->
        <div class="card-body">
    ...
    <!-- Card 2 -->
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/rana.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
    ...
    <!-- Card instrucciones -->
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/k.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
        <!-- <button type="button" class="btn btn-primary" value="" id="verificar"  onclick="indicarSorpresa()">Verificar</button> -->
        </div>
      </div>                  
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/kiwi.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
      ...
      <div class="card text-center border-info">
      <img class="card-img-top" src="./img/carro.jpg" alt="Card image cap"> <!--Referencia de la imagen-->
        <div class="card-body">
  ...
  <video id="repa" width="0" height="0"><source src="img/koala.ogg"></video> <!--Referencia del audio-->
  <video id="repb" width="0" height="0"><source src="img/rana.ogg"></video><!--Referencia de la audio-->
  <video id="repc" width="0" height="0"><source src="img/kiwi.ogg"></video><!--Referencia de la audio-->
  <video id="repd" width="0" height="0"><source src="img/carro.ogg"></video><!--Referencia de la audio-->
</body>
</html>
<script>
// Sorpresa y fallo
